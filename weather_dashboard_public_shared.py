...
c4.metric("🧭 Dirección del Viento (º)", f"Del {wind_direction_cardinal(latest.wind_direction)} ({latest.wind_direction:.0f}°)")
...
arrow_angles = (df_wind["wind_direction"])-270%60
