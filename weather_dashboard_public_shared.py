...
with c5:
    ...
    st.markdown(f"<p  style=color:#000000; font-size: 0.75rem; display:inline; margin: 0; line-height: 1;'>☀️ Índice UV</p>", unsafe_allow_html=True)
    st.markdown(f"<p style='color:{color}; font-size: 2.0rem; display:inline; margin: 0; line-height: 1;'>{latest.uv:.1f}</p>", unsafe_allow_html=True)
